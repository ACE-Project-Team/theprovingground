--[[--
    ...
    `TPG_RushHoldFrac`) rather than a net message of its own -- they are small,
    change at most once a scoring step, and a late-joining client gets the
    current values for free.
...
hook.Add("HUDPaint", "TPG_RushHUD", function()
    ...
    draw.SimpleText(string.format("STAGE %d OF %d", stage, stages), "TPG.HUD.Label",
